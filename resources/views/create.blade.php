                        ...
                        <div class="row">
                            ...
                            <div class="mt-4">
                                <div class="">
                                    ...
                                    <textarea
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        style="height:150px" name="detail" placeholder="Keterangan Produk"></textarea>
                                </div>
                            </div>
                            <div class="mt-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <div class="ms-2 text-sm">
                                            ...
                                            <p id="helper-checkbox-text"
                                                class="text-xs font-normal text-gray-500 dark:text-gray-300">Produk ini
                                                akan muncul ditampilan depan pada bagian "Best Seller"</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
