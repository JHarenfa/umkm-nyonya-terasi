    ...
    <div id="menu">
        <div class="container container-img">
            ...
            <div class="services-list">
                <div>
                    <a href="{{ route('makanan-berat') }}">
                        <i class="fa-solid fa-bowl-food fa-fade"></i>
                        <h2>Makanan Berat</h2>
                        <p>Tersedia makanan berat seperti Nasi Goreng, Mie, Kwetiau, Bihun, Ayam, Bebek, dan Seafood.
                        </p>
                    </a>
                </div>
                <div>
                    <a href="{{ route('gorengan') }}">
        ...
        <div class="container about-bg">
            <div class="row">
                ...
                <div class="about-col-2">
                    ...
                    <p>
                        Rumah Makan Nyonya Terasi adalah tempat yang menggabungkan kelezatan masakan Nusantara dengan
                        nuansa yang nyaman dan ramah. Setiap hidangan, mulai dari ayam hingga ikan, sate, dan soto,
                        disajikan dengan cita rasa autentik yang membuat lidah Anda terkagum-kagum. Namun, yang membuat
                        tempat ini benar-benar istimewa adalah sambalnya yang begitu enak dan mengundang untuk
                        dinikmati. Tersebar di beberapa lokasi di Batam seperti Nagoya, One Batam Mall, Batam Centre,
                        dan Tiban, Nyonya Terasi adalah tempat yang sempurna untuk menikmati kelezatan masakan
                ...
                <div class="row">
                    <div class="contact-left">
                        ...
                        <div class="social-icons">
                            ...
                            <a
                                href="https://gofood.co.id/en/batam/restaurant/nyonya-terasi-batam-centre-15af3a0b-dd86-43d2-9d47-f987241181f9"><i
                                    class="fa-solid fa-bag-shopping"></i></a>
                        </div>
                    </div>
                    <div class="contact-right">
                        <p><iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.0456195072375!2d104.04882487584796!3d1.1276485622479542!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d98d2aa9771b43%3A0x535d924531fded76!2sNyonya%20Terasi%2C%20Batam%20Centre!5e0!3m2!1sen!2sid!4v1714383753466!5m2!1sen!2sid"
